...
import banner1 from "../../assets/mobilebanner/mobile.jpg";
import banner2 from "../../assets/mobilebanner/Free-200-Bonus-2.webp";
import banner3 from "../../assets/mobilebanner/Deposit-Bonus-2.webp";
import banner4 from "../../assets/mobilebanner/Deposit-Trunover-2.webp";
const MobileBanner = () => {
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          onClick={prevSlider}
          className="absolute top-1/2 left-0 z-20 flex justify-center items-center  rounded-full w-8 h-8 md:w-10 md:h-10 transform -translate-y-1/2"
        >
          <svg
            className="icon h-6 w-6 fill-white md:h-8 md:w-8"
        ...
        <button
          onClick={nextSlider}
          className="absolute top-1/2 right-0 z-20 flex justify-center items-center rounded-full w-8 h-8 md:w-10 md:h-10 transform -translate-y-1/2"
        >
          <svg
            className="icon h-6 w-6 fill-white md:h-8 md:w-8"
            viewBox="0 0 1024 1024"
        ...
        >
          ...
          {carouselImages.map((slide, idx) => (
            <div key={slide} className="flex-shrink-0 w-full">
              <img
                src={slide}
